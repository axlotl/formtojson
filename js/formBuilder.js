  ...
  var FormBuilder = function(element, options) {
    ...
    var _helpers = {
      ...
      save: function() {
        ...
        // console.log($(ulObj).toSpigitXML());
        //elem.val($(ulObj).formToJSON());
        //console.log($(ulObj).formToJSON());
      },
    ...
    var cbHeader = $('<h4/>').html(opts.messages.editorTitle),
      ...
      }).html('<a class="save speuiButton_v1 corner-all-3 primary" href="#"><span>' + opts.messages.save + '</span></a>'),
      viewVars = $('<a/>', {
        id: frmbID + '-view-vars',
        href: '#',
        'class': 'view-vars',
    ...
    elem.before(ulObj).parent().prepend(frmbHeader).addClass('frmb-wrap').append(saveAll, actionLinks);
    ...
    $('.save.speuiButton_v1').off().on({
    	mousedown : function(e){
    		console.log('mousedown');
    		e.preventDefault();
    		var json = $('#frmb-0').formToJSON();
    		$('#ui-id-3').val(  json);
